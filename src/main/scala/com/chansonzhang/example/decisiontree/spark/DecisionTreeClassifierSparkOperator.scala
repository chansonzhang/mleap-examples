package com.chansonzhang.example.decisiontree.spark
...
object DecisionTreeClassifierSparkOperator {
  def main(args: Array[String]): Unit = {
    ...
    for (bf <- managed(BundleFile("jar:file:/Users/zhangchen/code/mleap-examples/tmp/dt-pipeline.zip"))) {
  ...
  def operator(df: DataFrame,
    ...
    val pipeline = new Pipeline()
      .setStages(Array(vectorAssembler, featureIndexer, dt, labelConvertor))
