package com.chansonzhang.example.randomforest
...
object LoadRandomForestClassifierPipeline {
  implicit val sbc: MleapContext = MleapContext()

  def main(args: Array[String]): Unit = {

    // load the Spark pipeline we saved in the previous section
    val bundle = (for (bundleFile <- managed(BundleFile("jar:file:/Users/zhangchen/code/mleap-examples/tmp/rf-pipeline.zip")))
      yield {
